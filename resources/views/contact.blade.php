...
@section('content')
    ...
    <div class="relative w-full h-[65vh]">
        <!-- Centered Text -->
        <h3 class="absolute inset-0 flex items-center justify-center text-4xl text-white kode-mono-text-font">
            Contact us
        </h3>
        
        <!-- Image -->
        <img src="{{ asset('images/about.jpg') }}" alt="contact image" class="w-full h-full mx-auto object-cover opacity-30">
    </div>

    <!-- cards working hrs -->
    <div class="flex flex-row justify-between items-center gap-10 pt-24 px-14 w-full">
    ...
    <!-- contact form here -->
    <div class="mt-20 border-2 border-limeGreen rounded-md shadow-md w-11/12 mx-14 px-10 py-12 flex flex-row justify-between items-start">
        <div class="w-full">
            <h3 class="text-white text-3xl">Lets discuss <span class="text-limeGreen">something</span> <p><span class="text-limeGreen">on</span> together</p></h3>

            <ul class="mt-14 text-white flex flex-col gap-y-3">
            ...
            <!-- icons -->
            <ul class="flex flex-row gap-4 justify-start items-start mt-24">
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-7 text-white cursor-pointer" fill="currentColor" viewBox="0 0 448 512">
                ...
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-7 text-white cursor-pointer" fill="currentColor" viewBox="0 0 512 512">
                        <path d="M459.4 151.7c.3 4.5 .3 9.1 .3 13.6 0 138.7-105.6 298.6-298.6 298.6-59.5 0-114.7-17.2-161.1-47.1 8.4 1 16.6 1.3 25.3 1.3 49.1 0 94.2-16.6 130.3-44.8-46.1-1-84.8-31.2-98.1-72.8 6.5 1 13 1.6 19.8 1.6 9.4 0 18.8-1.3 27.6-3.6-48.1-9.7-84.1-52-84.1-103v-1.3c14 7.8 30.2 12.7 47.4 13.3-28.3-18.8-46.8-51-46.8-87.4 0-19.5 5.2-37.4 14.3-53 51.7 63.7 129.3 105.3 216.4 109.8-1.6-7.8-2.6-15.9-2.6-24 0-57.8 46.8-104.9 104.9-104.9 30.2 0 57.5 12.7 76.7 33.1 23.7-4.5 46.5-13.3 66.6-25.3-7.8 24.4-24.4 44.8-46.1 57.8 21.1-2.3 41.6-8.1 60.4-16.2-14.3 20.8-32.2 39.3-52.6 54.3z"/>
                    </svg>
                </li>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-7 text-white cursor-pointer" fill="currentColor" viewBox="0 0 496 512">
        ...
        <div class="bg-white p-4 rounded-md w-full">
            <h3 class='text-lg'>I am interested in....</h3>
            <div class="flex flex-row gap-4 justify-start items-center pt-5 text-sm">
                ...
                <span class="border-2 border-limeGreen p-1.5 w-fit text-center rounded-sm cursor-pointer">Accesibility</span>
                <span class="border-2 border-limeGreen p-1.5 w-fit text-center rounded-sm cursor-pointer">Fast and Accuracy</span>
                <span class="border-2 border-limeGreen p-1.5 w-fit text-center rounded-sm cursor-pointer">Limitless</span>
            </div>
            <div class="mt-5">
