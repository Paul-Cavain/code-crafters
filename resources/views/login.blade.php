...
@section('content')
    <section class="flex flex-col md:flex-row w-full min-h-screen justify-center items-center py-10 md:py-0 md:px-32">
        <div class="w-full">
            ...
            <!-- Image -->
            <img src="{{ asset('images/login.png') }}" alt="contact image" class="md:w-full h-[60vh] md:h-full mt-10 md:mt-0 mx-auto object-cover opacity-30">
        </div>
        <div class="flex flex-col justify-center items-center w-full text-white text-center gap-y-4">
            ...
            <button class="flex flex-row justify-center items-center gap-x-4 px-14 text-black w-4/5 md:w-1/2 h-10 bg-white rounded-sm focus:outline-none text-center transition ease-out duration-500 hover:bg-darkGreen hover:text-white hover:border-2 hover:border-white mt-14 md:mt-0">
                <img src="{{ asset('images/google.png') }}" alt="google-icon" class="w-6 h-6 object-cover">
